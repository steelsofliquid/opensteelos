...
This directory contains the main source code for practically everything in the project - Built-in libraries, drivers, and of course, the kernel itself. Right now,there isn't much of some components, like a UI or package manager, but those *will* be implemented before it is too late, because if those aren't added, it will cause fragmentation which could deal a fatal blow to the project in the long-long-term.
